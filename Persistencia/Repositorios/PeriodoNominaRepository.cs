...
namespace Persistencia.Repositorios
{
    public class PeriodoNominaRepository : IPeriodoNominaRepository
    {
        ...
        public async Task GenerarNuevosPeriodosAnuales()
        {
          
            await _connection.ExecuteAsync(
                "dbo.sp_GenerarNuevosPeriodosAnuales",
                commandType: CommandType.StoredProcedure);
        }


        public async Task AnularNominaPeriodo(string periodoCodigo)
        {
            await _connection.ExecuteAsync(
                "dbo.sp_AnularNomina",
                new { PeriodoCodigo = periodoCodigo },
                commandType: CommandType.StoredProcedure);
        }
